...
public final class KycEvaluationSaga extends AggregateRoot<KycCaseId> {
    ...
    public static KycEvaluationSaga rehydrate(
            KycCaseId kycCaseId,
            CustomerId customerId,
            Set<String> requiredChecks,
            Set<String> completedChecks,
            KycEvaluationSagaState state
    ) {
        KycEvaluationSaga saga = new KycEvaluationSaga(kycCaseId, customerId, requiredChecks);
        saga.completedChecks.addAll(completedChecks);
        saga.state = state;
        return saga;
    }
    ...
    public Set<String> getRequiredChecks() {
        return requiredChecks;
    }

    public Set<String> getCompletedChecks() {
        return completedChecks;
    }

    public KycEvaluationSagaState getState() {
        return state;
    }
}
